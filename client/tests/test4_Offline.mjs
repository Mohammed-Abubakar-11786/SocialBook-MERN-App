...
describe("React App Selenium Test - Offline Test", function () {
  ...
  it("should show TestUser5 offline", async function () {
    ...
    await driver.get("http://localhost:5173/chatTo/669df965d137f9997ccb4175"); // Adjust URL as needed
    await driver.sleep(3000);
  });
});
